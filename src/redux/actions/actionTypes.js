...
export const HISTORY_SWITCHER = 'historyReducer/history switcher';
export const ADD_ITEM_TO_HISTORY = 'historyReducer/add item to history';
export const CLEAR_HISTORY = 'historyReducer/clear history';
